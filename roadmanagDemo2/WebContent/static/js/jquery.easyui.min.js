...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
_4ee.add(_4ef).children("div.datagrid-body").css({height:(_4f5-_4f6)});
}
...
(function($){
function init(_918){
var _919=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a  class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_918);
var t=$(_918);
